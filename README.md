...
```
python -m pip install git+https://github.com/TMALFSSISAWBOJBUMA/altiumate.git@v0.4.0

uv pip install git+https://github.com/TMALFSSISAWBOJBUMA/altiumate.git@v0.4.0
```
