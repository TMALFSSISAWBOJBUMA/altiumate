...
```
python -m pip install git+https://github.com/TMALFSSISAWBOJBUMA/altiumate.git@v0.1.2

uv pip install git+https://github.com/TMALFSSISAWBOJBUMA/altiumate.git@v0.1.2
```
